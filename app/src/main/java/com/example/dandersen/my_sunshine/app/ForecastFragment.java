...
/*
                ...
                int dayIndex = 0;
                double maxTemp = weatherDataParser.getMaxTemperatureForDay(forecastJsonStr, dayIndex);
                Log.v(LOG_TAG, "Max temperature for day " + Integer.toString(dayIndex) + ": " + Double.toString(maxTemp));
*/
